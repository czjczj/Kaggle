#!/usr/bin/env python
# -*- coding:utf-8 -*-
#@Time  : 2019/7/11 15:15
#@Author: czj
#@File  : Titanic_LastVersion.py
import numpy as np
import pandas as pd
...
train_file = "D:\\MyInstallData\\PyCharm\\Kaggle\\titanic\\train.csv"
MODEL_PATH = "./"
test_file = "D:\\MyInstallData\\PyCharm\\Kaggle\\titanic\\test.csv"
SUBMISSION_PATH = "./"
seed = 0
...
grid_search = GridSearchCV(pipeline, param_grid=param_grid, verbose=3, scoring='accuracy', cv=10).fit(X_train, Y_train)
# 对结果打分
print("Best score: %0.3f" % grid_search.best_score_)
print(grid_search.best_estimator_)
# report(grid_search.return_train_score)
